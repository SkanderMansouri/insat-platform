...
public class ClubResourceIntTest {
    ...
    private static final List<SlackUser> DEFAULT_MEMBERS = null;
    private static final List<SlackUser> UPDATED_MEMBERS = null;
    ...
    public void createClub() throws Exception {
        ...
        assertThat(testClub.getMembers()).isEqualTo(DEFAULT_MEMBERS);
    ...
    public void updateClub() throws Exception {
        ...
        assertThat(testClub.getMembers()).isEqualTo(UPDATED_MEMBERS);
