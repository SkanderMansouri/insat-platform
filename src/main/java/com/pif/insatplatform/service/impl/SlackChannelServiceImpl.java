...
public class SlackChannelServiceImpl implements SlackChannelService {
    ...
    public SlackChannelServiceImpl(SlackChannelRepository slackChannelRepository) {
    ...
    public SlackChannel save(SlackChannel slackChannel) {
        log.debug("Request to save SlackChannel : {}", slackChannel);        return slackChannelRepository.save(slackChannel);
    }
