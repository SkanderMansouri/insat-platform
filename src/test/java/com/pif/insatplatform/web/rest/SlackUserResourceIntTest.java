...
public class SlackUserResourceIntTest {
    ...
    public void createSlackUser() throws Exception {
        ...
        SlackUserDTO slackUserDTO = slackUserMapper.toDto(slackUser);
        restSlackUserMockMvc.perform(post("/api/slack-users")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(slackUserDTO)))
    ...
    public void updateSlackUser() throws Exception {
        ...
        SlackUserDTO slackUserDTO = slackUserMapper.toDto(updatedSlackUser);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(SlackUserDTO.class);
        SlackUserDTO slackUserDTO1 = new SlackUserDTO();
        slackUserDTO1.setId(1L);
        SlackUserDTO slackUserDTO2 = new SlackUserDTO();
        assertThat(slackUserDTO1).isNotEqualTo(slackUserDTO2);
        slackUserDTO2.setId(slackUserDTO1.getId());
        assertThat(slackUserDTO1).isEqualTo(slackUserDTO2);
        slackUserDTO2.setId(2L);
        assertThat(slackUserDTO1).isNotEqualTo(slackUserDTO2);
        slackUserDTO1.setId(null);
        assertThat(slackUserDTO1).isNotEqualTo(slackUserDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(slackUserMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(slackUserMapper.fromId(null)).isNull();
    }
}
