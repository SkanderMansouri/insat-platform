...
import { SlackChannelComponent } from 'app/entities/slack-channel/slack-channel.component';
...
describe('Component Tests', () => {
    describe('SlackChannel Management Component', () => {
        let comp: SlackChannelComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SlackChannelComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.slackChannels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
