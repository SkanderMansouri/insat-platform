package insat.company.platform.security.oauth2;


import insat.company.platform.exception.BadRequestException;
import insat.company.platform.config.AppProperties;
import insat.company.platform.security.TokenProvider;
import insat.company.platform.util.CookieUtils;
...
import static insat.company.platform.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
/*
