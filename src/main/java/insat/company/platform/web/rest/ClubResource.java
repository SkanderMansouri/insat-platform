...
public class ClubResource {
    ...
    @GetMapping("/clubs")
    @Timed
    public List<Club> getAllClubs(@RequestParam(required = false) String filter) {
        if ("president-is-null".equals(filter)) {
            log.debug("REST request to get all Clubs where president is null");
            return clubService.findAllWherePresidentIsNull();
        }
